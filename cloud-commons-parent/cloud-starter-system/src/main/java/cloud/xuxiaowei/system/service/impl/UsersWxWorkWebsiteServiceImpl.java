...
import cloud.xuxiaowei.system.mapper.UsersWxWorkWebsiteMapper;
 ...
 */
@Service
public class UsersWxWorkWebsiteServiceImpl extends ServiceImpl<UsersWxWorkWebsiteMapper, UsersWxWorkWebsite>
		implements IUsersWxWorkWebsiteService {
	 ...
	 */
	@Override
	public UsersWxWorkWebsite getByAppidAndAgentidAndOpenid(String appid, String agentid, String openid) {
	...
	public boolean unbinding(Long usersId) {
		UpdateWrapper<UsersWxWorkWebsite> updateWrapper = new UpdateWrapper<>();
