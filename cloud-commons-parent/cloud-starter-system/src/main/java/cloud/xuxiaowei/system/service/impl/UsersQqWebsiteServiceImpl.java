...
import cloud.xuxiaowei.system.mapper.UsersQqWebsiteMapper;
 ...
 */
@Service
public class UsersQqWebsiteServiceImpl extends ServiceImpl<UsersQqWebsiteMapper, UsersQqWebsite>
		implements IUsersQqWebsiteService {
	 ...
	 */
	@Override
	public UsersQqWebsite getByAppidAndOpenid(String appid, String openid) {
	...
	public void binding(long usersId, String appid, String openid) {
		UpdateWrapper<UsersQqWebsite> updateWrapper = new UpdateWrapper<>();
