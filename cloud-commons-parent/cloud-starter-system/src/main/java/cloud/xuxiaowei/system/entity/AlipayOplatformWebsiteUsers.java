 ...
 */
@Data
@TableName("alipay_oplatform_website_users")
public class AlipayOplatformWebsiteUsers implements Serializable {
	 ...
	 * 支付宝小程序用户主键ID，自增
	 */
	@TableId(value = "alipay_oplatform_website_users_id", type = IdType.AUTO)
	private Long alipayOplatformWebsiteUsersId;
