 ...
 */
@Data
@TableName("users_alipay_oplatform_website")
public class UsersAlipayOplatformWebsite implements Serializable {
	 ...
	 * 支付宝小程序用户主键ID，自增
	 */
	@TableId(value = "users_alipay_oplatform_website_id", type = IdType.AUTO)
	private Long usersAlipayOplatformWebsiteId;
