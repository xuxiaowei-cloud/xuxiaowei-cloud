 ...
 */
@Data
@TableName("qq_website_users")
public class QqWebsiteUsers implements Serializable {
	 ...
	 * QQ网站应用，主键，自增
	 */
	@TableId(value = "qq_website_users_id", type = IdType.AUTO)
	private Long qqWebsiteUsersId;
