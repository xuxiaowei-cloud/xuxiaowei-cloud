 ...
 */
@Data
@TableName("users_alipay_miniprogram")
public class UsersAlipayMiniprogram implements Serializable {
	 ...
	 * 支付宝小程序用户主键ID，自增
	 */
	@TableId(value = "users_alipay_miniprogram_id", type = IdType.AUTO)
	private Long usersAlipayMiniprogramId;
