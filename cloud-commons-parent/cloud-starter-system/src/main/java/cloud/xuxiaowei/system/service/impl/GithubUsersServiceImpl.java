...
import cloud.xuxiaowei.system.mapper.GithubUsersMapper;
 ...
 */
@Service
public class GithubUsersServiceImpl extends ServiceImpl<GithubUsersMapper, GithubUsers> implements IGithubUsersService {
	 ...
	 */
	@Override
	public GithubUsers getByAppidAndId(String appid, int id) {
	...
	public void binding(long usersId, String appid, int id) {
		UpdateWrapper<GithubUsers> updateWrapper = new UpdateWrapper<>();
