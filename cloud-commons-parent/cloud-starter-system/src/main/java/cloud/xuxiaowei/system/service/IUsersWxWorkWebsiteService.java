 ...
 * @since 2023-01-29
 */
public interface IUsersWxWorkWebsiteService extends IService<UsersWxWorkWebsite> {
	 ...
	 * @return 用户
	 */
	UsersWxWorkWebsite getByAppidAndAgentidAndOpenid(String appid, String agentid, String openid);
