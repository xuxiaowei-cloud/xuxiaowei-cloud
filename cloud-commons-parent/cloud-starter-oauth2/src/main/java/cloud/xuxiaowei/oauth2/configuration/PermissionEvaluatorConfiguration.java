 ...
 * {@link DefaultMethodSecurityExpressionHandler#setPermissionEvaluator(PermissionEvaluator)}
...
public class PermissionEvaluatorConfiguration implements PermissionEvaluator {
	...
	public boolean hasPermission(Authentication authentication, Object targetDomainObject, Object permission) {
		log.warn("cloud-starter-oauth2组件 的 权限评估（需要自己实现），参数：authentication：{}, permission：{}", authentication,
				permission);
		return true;
	}
	...
	public boolean hasPermission(Authentication authentication, Serializable targetId, String targetType,
			Object permission) {
		log.warn("cloud-starter-oauth2组件 的 权限评估（需要自己实现），参数：authentication：{}, targetId：{}，targetType：{}，permission：{}",
