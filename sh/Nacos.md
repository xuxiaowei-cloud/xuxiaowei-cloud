...
- 本项目使用版本
    ...
    - [nacos-server-2.1.2.tar.gz](https://github.com/alibaba/nacos/releases/download/2.1.2/nacos-server-2.1.2.tar.gz)
    - 解压：`tar -zxvf nacos-server-2.1.2.tar.gz`
    - 安装目录
        - /software/nacos-server-2.1.2
