<template>
  <div id="cloud-el-search">
    ...
    <el-button class="cloud-el-remove" @click="cloudRemove" v-if="hasAuthority('audit_authorization_delete')">删除
    </el-button>
  </div>
  <el-container>
    <el-table stripe :data="tableData" v-loading="loading" height="460" @selection-change="handleSelectionChange">
      <el-table-column type="expand">
        <template #default="props">
          <el-form label-width="160px">
            ...
            <el-form-item label="authorizationCodeExpiresAt">
              <el-input v-model="props.row.authorizationCodeExpiresAt" class="cloud-el-expand-input" disabled/>
            </el-form-item>
            <el-form-item label="authorizationCodeIssuedAt">
              <el-input v-model="props.row.authorizationCodeIssuedAt" class="cloud-el-expand-input" disabled/>
            </el-form-item>
            <el-form-item label="accessTokenType">
              <el-input v-model="props.row.accessTokenType" class="cloud-el-expand-input" disabled/>
            </el-form-item>
            <el-form-item label="accessTokenScopes">
              <el-input v-model="props.row.accessTokenScopes" class="cloud-el-expand-input" disabled/>
            </el-form-item>

            <el-form-item label="accessTokenMetadata">
              <el-input v-model="props.row.accessTokenMetadata" class="cloud-el-expand-textarea" type="textarea"
                        disabled rows="5"/>
            </el-form-item>
            <el-form-item label="accessTokenValue">
              <el-input v-model="props.row.accessTokenValue" class="cloud-el-expand-textarea" type="textarea" disabled
                        rows="5"/>
            </el-form-item>
            <el-form-item label="attributes">
              <el-input v-model="props.row.attributes" class="cloud-el-expand-textarea" type="textarea" disabled
                        rows="5"/>
            </el-form-item>
            <el-form-item label="authorizationCodeMetadata">
              <el-input v-model="props.row.authorizationCodeMetadata" class="cloud-el-expand-textarea" type="textarea" disabled
                        rows="5"/>
            </el-form-item>
            <el-form-item label="authorizationCodeValue">
              <el-input v-model="props.row.authorizationCodeValue" class="cloud-el-expand-textarea" type="textarea" disabled
                        rows="5"/>
            </el-form-item>

            <el-form-item label="oidcIdTokenExpiresAt">
              <el-input v-model="props.row.oidcIdTokenExpiresAt" class="cloud-el-expand-input" disabled/>
            </el-form-item>
            <el-form-item label="oidcIdTokenIssuedAt">
              <el-input v-model="props.row.oidcIdTokenIssuedAt" class="cloud-el-expand-input" disabled/>
            </el-form-item>
            <el-form-item label="oidcIdTokenMetadata">
              <el-input v-model="props.row.oidcIdTokenMetadata" class="cloud-el-expand-input" disabled/>
            </el-form-item>
            <el-form-item label="oidcIdTokenValue">
              <el-input v-model="props.row.oidcIdTokenValue" class="cloud-el-expand-input" disabled/>
            </el-form-item>

            <el-form-item label="refreshTokenMetadata">
              <el-input v-model="props.row.refreshTokenMetadata" class="cloud-el-expand-textarea" type="textarea"
                        disabled rows="5"/>
            </el-form-item>
            <el-form-item label="refreshTokenValue">
              <el-input v-model="props.row.refreshTokenValue" class="cloud-el-expand-textarea" type="textarea" disabled
                        rows="5"/>
            </el-form-item>
      ...
      <el-table-column fixed="right" label="Operations" width="100" v-if="hasAuthority('audit_authorization_delete')">
