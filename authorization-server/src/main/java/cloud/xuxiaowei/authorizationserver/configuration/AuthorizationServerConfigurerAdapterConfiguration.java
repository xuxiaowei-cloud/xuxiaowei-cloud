 ...
 * @see <a href="http://authorization-server.example.xuxiaowei.cloud:1301/oauth/authorize?client_id=xuxiaowei_client_id&redirect_uri=http://passport.example.xuxiaowei.cloud:1401/code&response_type=code&scope=snsapi_base&state=beff3dfc-bad8-40db-b25f-e5459e3d6ad7">获取 code</a>
 * @see <a href="http://authorization-server.example.xuxiaowei.cloud:1301/oauth/authorize?client_id=xuxiaowei_client_id&redirect_uri=http://passport.example.xuxiaowei.cloud:1401/code&response_type=code&scope=snsapi_userinfo&state=beff3dfc-bad8-40db-b25f-e5459e3d6ad7">获取 code</a>
 * @see <a href="http://authorization-server.example.xuxiaowei.cloud:1301/oauth/authorize?client_id=xuxiaowei_client_id&redirect_uri=http://passport.example.xuxiaowei.cloud:1401/code&response_type=token&scope=snsapi_base&state=beff3dfc-bad8-40db-b25f-e5459e3d6ad7">获取 Token（implicit，简化模式）</a>
 * @see <a href="http://authorization-server.example.xuxiaowei.cloud:1301/oauth/token?code=&client_id=xuxiaowei_client_id&client_secret=xuxiaowei_client_secret&redirect_uri=http://passport.example.xuxiaowei.cloud:1401/code&grant_type=authorization_code">获取 Token</a>
