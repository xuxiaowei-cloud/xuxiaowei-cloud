...
-- ----------------------------
-- Table structure for alipay_miniprogram_users
-- ----------------------------
DROP TABLE IF EXISTS `alipay_miniprogram_users`;
CREATE TABLE `alipay_miniprogram_users`  (
  `alipay_miniprogram_users_id` bigint NOT NULL AUTO_INCREMENT COMMENT '支付宝小程序用户主键ID，自增',
  ...
  `auth_start` datetime NULL DEFAULT NULL COMMENT '授权token开始时间，作为有效期计算的起点',
  ...
  PRIMARY KEY (`alipay_miniprogram_users_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付宝小程序用户' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for alipay_oplatform_website_users
-- ----------------------------
DROP TABLE IF EXISTS `alipay_oplatform_website_users`;
CREATE TABLE `alipay_oplatform_website_users`  (
  `alipay_oplatform_website_users_id` bigint NOT NULL AUTO_INCREMENT COMMENT '支付宝小程序用户主键ID，自增',
  `appid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `users_id` bigint NULL DEFAULT NULL COMMENT '用户表主键',
  `user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '支付宝用户的userId。支付宝用户的唯一标识。以2088开头的16位数字。',
  `union_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'union_id是支付宝用户在开放平台的唯一标识符，在配置应用分组后会返回该值。 同一用户的union_id在同一分组内应用保持一致。',
  `open_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '支付宝用户的openId，支付宝用户唯一标识',
  `taobao_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '淘宝id',
  ...
  `update_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新者IP，未更新时为空',
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除，0 未删除，1 删除，MySQL 默认值 0，不为 NULL，注解@TableLogic。',
  PRIMARY KEY (`alipay_oplatform_website_users_id`) USING BTREE
...
-- ----------------------------
-- Table structure for dingtalk_users
-- ----------------------------
...
CREATE TABLE `dingtalk_users`  (
  ...
  `expire_in` bigint NULL DEFAULT NULL COMMENT '超时时间',
  ...
  `update_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新者IP，未更新时为空',
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除，0 未删除，1 删除，MySQL 默认值 0，不为 NULL，注解@TableLogic。',
  PRIMARY KEY (`dingtalk_users_id`) USING BTREE
...
-- ----------------------------
-- Table structure for qq_miniprogram_users
-- ----------------------------
DROP TABLE IF EXISTS `qq_miniprogram_users`;
CREATE TABLE `qq_miniprogram_users`  (
  `qq_miniprogram_users_id` bigint NOT NULL AUTO_INCREMENT COMMENT 'QQ小程序用户主键ID，自增',
  `appid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '小程序标识，不为空，唯一键：uk__qq_miniprogram_users__appid__openid',
  `openid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户标识（针对于某个小程序），不为空，唯一键：uk__qq_miniprogram_users__appid__openid',
  ...
  `update_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新者IP，未更新时为空',
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '逻辑删除，0 未删除，1 删除，MySQL 默认值 0，不为 NULL，注解@TableLogic。',
  PRIMARY KEY (`qq_miniprogram_users_id`) USING BTREE,
  UNIQUE INDEX `uk__qq_miniprogram_users__appid__openid`(`appid`, `openid`) USING BTREE
